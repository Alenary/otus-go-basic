...
2) [«Чиним, собираем и запускаем приложение»](hw06_project/hw02_fix_app)
3) [«Шахматная доска»](hw06_project/hw03_chessboard)
4) [«Компаратор структур»](hw06_project/hw04_struct_comparator)
5) [«Подсчет площади геометрических фигур»](hw06_project/hw05_shapes)
6) [«Покрыть тестами предыдущие задания»](hw06_project/hw06_testing)
